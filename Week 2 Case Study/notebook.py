...
class Note:
    ...
    def __init__(self, memo, tags="", title=""):
    ...
    def match(self, filter_text):
        ...
        tags."""
        return filter_text in self.memo or filter_text in self.tags or filter_text in self.title
...
class Notebook:
    ...
    def new_note(self, memo, tags="", title=""):
        """Create a new note and add it to the list."""
        self.notes.append(Note(memo, tags, title))
